...
X_training = [[float(j[0]), float(j[1])] for j in data_train]
y_training = [[j[2],j[3],j[4],j[5],j[6],j[7],j[8]] for j in data_train]
X_testing = [[float(j[0]), float(j[1])] for j in data_test]
y_testing = [[j[2],j[3],j[4],j[5],j[6],j[7],j[8]] for j in data_test]
